...
class PreTrainedPolicyAction(ActionTerm):
    ...
    def __init__(self, cfg: PreTrainedPolicyActionCfg, env: ManagerBasedRLEnv) -> None:
        ...
        cfg.low_level_env_cfg.observations.actions.func = lambda dummy_env: last_action()
        cfg.low_level_env_cfg.observations.actions.params = dict()
    ...
    def command_dim(self) -> int:
        #FIXME(OKJ)
        # return self._low_level_obs_manager.group_obs_term_dim[self.cfg.command_name]
